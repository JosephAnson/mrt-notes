      ...
      <template #item="{ element }">
        <div class=" flex w-full bg-gray-800 py-2 px-4 mb-2 rounded-1">
          ...
          <div class="w-full">
                  ...
                  <div
                    ...
                    <TransitionRoot leave="transition ease-in duration-100" leave-from="opacity-100" leave-to="opacity-0"
                      ...
                      <ComboboxOptions
                        ...
                        <div v-if="filteredMembers.length === 0 && query !== ''"
                          class="relative cursor-default select-none py-2 px-4 text-gray-700">
                          Nothing found.
                        </div>
                        <ComboboxOption v-for="member in filteredMembers" :key="member.id" v-slot="{ selected, active }"
                          as="template" :value="member.name">
            ...
            <Field stacked>
              <Editor v-model="element.note.value" @update:json="element.note.json = $event"
